...
<body>
          ...
          <a class="navbar-brand fw-bold text-light fs-3" href="https://cit.kmutnb.ac.th/">CIT</a>
            ...
            <div class="col-3">
                <form class="d-flex" role="search">
                    <input class="form-control me-2" type="search" placeholder="CourseDetail" aria-label="Search">
    ...
    <div class="container mt-4">
        <div class="row">
            ...
            <div class="col-6">
                <div class="card">
                    <div class="card-header fw-bold" style="background-color: #F1BB93;">
                        CourseID
                    </div>
    ...
    <div class="container mt-4">
        <div class="row">
            ...
            <div class="col-6" >
                <ul class="list-group" >
                    <li class="list-group-item" style="background-color: #F1EBCC;">Comment 1</li>
                    <li class="list-group-item" style="background-color: #F1EBCC;">Comment 2</li>
                    <li class="list-group-item" style="background-color: #F1EBCC;">Comment 3</li>
                    <li class="list-group-item" style="background-color: #F1EBCC;">Comment 4</li>
                    <li class="list-group-item" style="background-color: #F1EBCC;">Comment 5</li>
                </ul>
            </div>
        </div>
    </div>
        ...
        <div class="row" >
            ...
            <div class="col-6">
                  <div class="mb-3">
                    ...
                    <textarea class="form-control " id="exampleFormControlTextarea1"style="height: 200px;" rows="3"></textarea>
                  </div>
            </div>
        </div>
    </div>
